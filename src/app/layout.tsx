...
export const metadata: Metadata = {
  title: "Kris Kellaway's Delicious Meals - Authentic Italian Restaurant in Rome",
  description: "Experience authentic Italian cuisine in the heart of Rome. Traditional recipes, fresh ingredients, and warm hospitality. Reserve your table today.",
  keywords: "Italian restaurant Rome, authentic Italian cuisine, traditional pasta, Roman food, dining in Rome",
  openGraph: {
    title: "Kris Kellaway's Delicious Meals",
    description: "Authentic Italian dining in Rome since 2015",
    siteName: "Kris Kellaway's Delicious Meals",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764612802217-349behzi.jpg",
        alt: "Elegant Italian restaurant in Rome"
      }
    ]
  },
  twitter: {
    ...
    title: "Kris Kellaway's Delicious Meals",
    description: "Authentic Italian dining in Rome",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764612802217-349behzi.jpg"]
  }
};
